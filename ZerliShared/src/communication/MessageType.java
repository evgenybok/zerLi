...
public enum MessageType {
    ...
    ,GET_SURVEY_NUMBER,INSERT_NEW_SURVEY, CHECK_EXIST_QOMPLAIN, CHECK_ORDER_BY_USERID, INCOME_REPORT, GET_STORE_ID_BY_WORKER_ID, GRAPH_STATISTICS, GET_STORE_NAME_BY_ID;
	/* Message from Server */
	...
	VIEW_SELF_DELIVERY_DETAILS_BY_ORDERID, GET_SINGLE_DELIVERY_BY_STORE_ID, GET_SURVEY_ANSWERS, GET_STORE_ORDERS;
