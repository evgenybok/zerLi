...
public class CEOScreenController {
	...
	void initialize() {
		try {
			...
			this.AccountStatus.setText(account.get(5));		//*** AccountStatus text field is null!!
			this.AccountType.setText(LoginScreenController.user.getRole());
			this.UserName.setText(LoginScreenController.user.getUsername());
		} catch (NullPointerException e) {};

		assert AccountType != null
				: "fx:id=\"AccountType\" was not injected: check your FXML file 'CEOScreenNew.fxml'.";
		assert ComplainRep != null
				: "fx:id=\"ComplainRep\" was not injected: check your FXML file 'CEOScreenNew.fxml'.";
