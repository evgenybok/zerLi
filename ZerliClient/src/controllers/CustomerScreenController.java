...
public class CustomerScreenController {
    ...
    void btnLogout(MouseEvent event) throws IOException {
    	...
    	Parent parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/controllers/LoginScreen.fxml")));
    ...
    void btnViewOrders(MouseEvent event) throws IOException {
    	...
    	Parent parent = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/controllers/OrderScreen.fxml")));
		Scene scene = new Scene(parent);
		Stage LoginStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
